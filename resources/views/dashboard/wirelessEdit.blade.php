...
@section('content')
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="card">
                <form method="post" action="/dashboard/value/edit/{{$wireless->id}}" class="form-horizontal">
                    {{ csrf_field() }}
                    ...
                    <div class="card-content">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group label-floating is-empty">
                                    ...
                                    <input name="value" type="number" class="form-control" value="{{ $wireless->value }}"
                                           required/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group label-floating is-empty">
                                    <label class="control-label"></label>
                                    <input name="name" type="text" class="form-control" value="{{ $wireless->name }}"
                                           required/>
                                    <span class="help-block">Enter Value ...</span>
                                </div>
                            </div>
