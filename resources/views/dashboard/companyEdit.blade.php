        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    ...
                    @endif
                    <div class="card">
                        <form enctype="multipart/form-data" method="POST" action="/dashboard/company/edit/{{$company->id}}" class="form-horizontal">
                            {{ csrf_field() }}
                            ...
                            <div class="card-content">
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group label-floating is-empty">
                                            ...
                                            <input name="name" type="text" class="form-control" value="{{ $company->name }}" required />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group label-floating is-empty">
                                            <label class="control-label"></label>
                                            <input name="address" type="text" class="form-control" value="{{ $company->address }}" required />
